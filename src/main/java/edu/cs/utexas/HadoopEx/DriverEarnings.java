...
public class DriverEarnings extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new DriverEarnings(), args);
		System.exit(res);
	}
	...
	public int run(String args[]) {
		try {
			...
			job.setJarByClass(DriverEarnings.class);
			...
			job2.setJarByClass(DriverEarnings.class);
